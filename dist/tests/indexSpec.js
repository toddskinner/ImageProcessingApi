...
describe('should get the right responses for each endpoint', function () {
    ...
    it('should not get the api endpoint if width param less than zero', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api/?name=fjord&width=-1000&height=1000')];
                case 1:
                    response = _a.sent();
                    expect(response.status).toBe(404);
                    done();
    ...
    it('should not get the api endpoint if image name param not valid', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api/?name=oakland&width=1000&height=-1000')];
                case 1:
                    response = _a.sent();
                    expect(response.status).toBe(404);
                    done();
